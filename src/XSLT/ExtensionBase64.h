...
#ifndef EXTENSIONBASE64_H
#define EXTENSIONBASE64_H
...
namespace FinTP
{
	class ExportedObject FunctionBase64 : public Function
	{
		public:
			...
			#else
				virtual FunctionBase64* clone( MemoryManagerType& theManager ) const;
			#endif
		protected:
		...
		private:
			...
			FunctionBase64& operator=( const FunctionBase64& );
			bool operator==( const FunctionBase64& ) const;
	};
}

#endif // EXTENSIONBASE64_H
