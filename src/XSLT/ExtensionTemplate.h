...
#ifndef EXTENSIONTEMPLATE_H
#define EXTENSIONTEMPLATE_H
...
namespace FinTP
{
	class ExportedObject FunctionFill : public Function
	{
		public:
			...
			#else
				virtual FunctionFill* clone( MemoryManagerType& theManager ) const;
			#endif
		protected:
			...
			#else
				virtual FunctionFill* clone() const;
			#endif	
		protected:
		...
		private:
			...
			FunctionFill& operator=( const FunctionFill& );
			bool operator==( const FunctionFill& ) const;
	};
}

#endif // EXTENSIONTEMPLATE_H
