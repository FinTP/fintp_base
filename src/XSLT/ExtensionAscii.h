...
#ifndef EXTENSIONASCII_H
#define EXTENSIONASCII_H
...
namespace FinTP
{
	class ExportedObject FunctionAscii : public Function
	{
		public:
			...
			#else
				virtual FunctionAscii* clone( MemoryManagerType& theManager ) const;
			#endif
		protected:
			...
			#else
				virtual FunctionAscii* clone() const;
			#endif	
		protected:
		...
		private:
			...
			FunctionAscii& operator=( const FunctionAscii& );
			bool operator==( const FunctionAscii& ) const;
	};
}

#endif // EXTENSIONASCII_H
